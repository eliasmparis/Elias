...
<!-- Header --><body>
  ...
  <main class="content">
    ...
    <div class="header-list-page">  
        ...
        <form action="CategoriaConsultarServlet" id="formulario" method="get"> 
        <h1 class="title">Categories</h1> 
        <a href="addCategory.jsp" class="btn-action">Add new Category</a> 
                    ...
                    <div class="form-group col-8">
                        ...
                        <input type="submit" id="acao" name="acao" class="" value="Filtrar" onclick="javascript: CategoriaConsultarServlet">
                    </div>
        <br>
            ...
            <table class="data-grid">
              <tr class="data-row">
                ...
                <%
                     ...
                     if (Categoria == null) Categoria = new Categoria[0];

                     for (int i=0; i<Categoria.length; i++) {
                %>
                     
                <tr>
                    <td> <input type="radio" name="selecao" value="<%= Categoria[i].getNome()%>"></td>
                    <td><%= Categoria[i].getNome()%></td>
                    <td><%= Categoria[i].getCodigo()%></td>
                </tr>
                <%
                    }
                %>
