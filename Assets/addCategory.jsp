...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="CategoriaSalvarServlet" id="formulario" method="post">
      ...
      <div class="input-field">
        ...
        <input type="number" name="codigo" id="codigo" class="input-text" />
        
      </div>
      <div class="actions-form">
        <a href="categories.jsp" class="action back">Back</a>
        <input class="btn-submit btn-action"  id="acao" name="botao" type="submit" value="Salvar" />
      </div>
    </form>
  </main>
  <!-- Main Content -->
